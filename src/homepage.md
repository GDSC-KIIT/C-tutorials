...
This text is primarily targetted towards the incoming freshmen at KIIT who will be taking the **Introduction to Programming in C**
...
We have tried to focus on these 3 points a lot :

1. Real Life Applications
2. Visual Aids (plenty in this doc)
...
A project by [**Junaid**](https://twitter.com/junaidrahim31) and [**Priyansi**](https://twitter.com/iiverveii)
